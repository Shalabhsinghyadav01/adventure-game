...
ques_first = input('You\'re at a crossroad. Where do you want to go? Type "left" or "right"').lower()
# print(ques_first)
if ques_first == "left":
...
#      if ques_first == "red":
#       print("It's a room full of fire. Game Over.")
#      elif ques_first == "blue":
#       print("You enter a room of beasts. Game Over.")
#      elif ques_first == "yellow":
#       print("You found the treasure! You Win!")
# else:
#   print("You chose a door that doesn't exist. Game Over.")
